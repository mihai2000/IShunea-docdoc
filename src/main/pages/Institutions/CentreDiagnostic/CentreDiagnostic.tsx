                        ...
                        <div className="Item">
                            <div className="row">
                                <div className="col-sm-3">
                                    <div className="Left">
                                        <a href="http://www.docdoc.md/ro/clinics/excellence" className="Logo">
                                            <img
                                ...
                                <div className="col-sm-6">
                                    <div className="Info">
                                        ...
                                        <p>Centrul Medical “EXCELLENCE” este o instituţie multifuncţională de
                                            diagnostic, asistenţă medicală primară şi specializată. Chiar de la
                                            deschiderea centrului, în ianuarie 2008, ne-am propus să oferim
                                            clienţilor noştri servicii medicale complete, la un înalt standard calitativ
                                            folosind cel mai performant utilaj medical de diagnostic şi laborator.
                                            Integrarea parţială a Centrului Medical în
                                            sistemul asigurărilor de sănătate existent în Republica Moldova ne permite
                                            să oferim clienţilor/pacienţilor toate facilitaţile aferente statutului de
                                            contribuabil la Compania Naţională de asigurări
                                            în Medicină.  <br/>
                                             Centrul Medical <q>Excellence</q> vine acum în întâmpinarea
                                                necesitaţilor moderne de diagnostic rapid şi eficient, oferind evaluări
                                                de performanţă înaltă şi asigurând servicii medicale la
                                                standarde europene, prestate de personal medical competent.
                                                Asistenţa medicală în CM <q>Excellence</q> acoperă peste 12 specialităţi
                                                    medicale, 9 explorări paraclinice şi peste 300 tipuri de analize de
                                                    laborator. Misiunea noastră este de a oferi servicii
                                                    care să raspundă la cele mai exigente cerinte medicale de
                                                    profesionalism, siguranţă şi confort. In opinia noastră medicina
                                                    modernă presupune şi o schimbare a mentalităţii pacienţilor despre
                                                    propria
                                                    sănătate, o schimbare a atitudinii în relaţia medic-pacient şi
                                                    realizarea unui climat propice comunicării permanente în beneficiul
                                                    pacienţilor.</p>
                                        <a href="http://www.docdoc.md/files/2018/05/17/1ef0ba9035561342b054ada47992bce7/price 2018.pdf"
                                           target="_blank" className="PriceList">Vezi price-list complet</a>
                                    </div>
                                </div>
                                <div className="col-sm-3">
