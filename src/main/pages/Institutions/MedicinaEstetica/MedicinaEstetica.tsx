                                                    ...
                                                    <div className="Left">
                                                        ...
                                                        <div className="Map">
                                                            ...
                                                            <div className="PopupAjaxed"
                                                                 data-action="http://www.docdoc.md/ro/clinics/amc-centrul-medical-american?Map">Mărește
                                                                harta
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="col-sm-6">
                                                    <div className="Info">
                                                        ...
                                                        <p>American Medical Center este o clinică multidisciplinară,
                                                            axată pe medicina personalizată, ce asigură cele mai moderne
                                                            metode de diagnostic și tratament. Clinica AMC vine în
                                                            întâmpinarea pacienților
                                                ...
                                                <div className="col-sm-3">
                                                    <div className="Details">
                                                        ...
                                                        <button className="Button PopupAjaxed basic-info-button"
                                                                data-action="http://www.docdoc.md/ro/appointments/2/2930?ServiceId=&Price=0&Currency=MDL">Înscriere
                                                        </button>
