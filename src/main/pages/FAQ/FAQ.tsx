            ...
            <div className="container ">
                <div className="row">
                    ...
                    <div className="title-div"><span>Ce este docdoc.md?</span>
                        <p>docdoc.md este un serviciu de căutare a medicilor și de programare prealabilă la consultație.
                            Noi ajutăm pacienții
                    ...
                    <div className="title-div"><span>docdoc.md este o clinică?</span>
                        <p>Nu, docdoc.md este un serviciu unde vă puteți găsi și face o programare la o clinică
                            de &icirc;ncredere.
                    ...
                    <div className="title-div"><span>Pot face o programare la oricare medic din Moldova?</span>
                        <p>Acum docdoc.md este
                            accesibil doar &icirc;n Chișinău, &icirc;n sectoarele - Botanica,Centru, Ciocana,
                            R&icirc;șcani,
                            Buicani, Sculeni și Telecentru. Suntem &icirc;n curs de dezvoltare și dorim să facem acces
                            la serviciul
                    ...
                    <div className="title-div"><span>docdoc.md este gratuit pentru pacienți?</span>
                        <p>Da, serviciul național de programare la doctor
                            este absolut gratuit pentru pacienți. Plata serviciilor medicale se achită la
                            clinica &icirc;n
                            care pacientul se adresează.</p>
                    </div>
                    <div className="title-div">
                        <span>C&acirc;t costă o consultație la doctor prin intermediul docdoc.md?</span>
                        <p>Costul consultației la medic,
                            depinde de clinica &icirc;n care lucrează. Noi garantăm că nu supraestimăm costul
                            serviciilor și prețul
                    ...
                    <div className="title-div"><span>Cum să aleg un medic bun pe site-ul docdoc.md?</span>
                        <p>Selectați medicul specialist și regiunea unde locuiți. Din lista de specialiști puteți
                            alege doctorul de care aveți nevoie. Aveți posibilitatea să clasați medicii după
                            vechimea &icirc;n
                    ...
                    <div className="title-div"><span>Cum pot face o programare la medic?</span>
                        <p>Vă puteți programa la consultație prin telefon sau lăs&acirc;nd o cerere direct pe
                            chestionarul
                            medicului.</p>
                    </div>
                    ...
                    <div className="title-div"><span>Cum să am acces la &rdquo;Cabinetul meu&rdquo;?</span>
                        <p>Loginul și Parola pentru &bdquo;Cabinetul meu&rdquo; &icirc;l poate primi medicul
                            sau clinica din partea departamentului de &icirc;nregistrare după semnarea unui contract de
                            colaborare.</p>
                    </div>
                    <div className="title-div"><span>Cum se postează profilul medicilor pe site?</span>
                        <p>Profilul medicilor se postează pe site, prin intermediul departamentului
                            de &icirc;nregistrare,
