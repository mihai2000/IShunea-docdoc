        ...
        <section className="doc-info-sistem">
            <div className="container">
                <div className="row doc-info-sistem">
                    <div className="col-lg-4 col-md-6 col-sm-12 col-xs-12 positions">
                    ...
                    <div className="col-lg-4 col-md-6 col-sm-12 col-xs-12 rating">
                        <div className="doc-info-sistem__icon-block">
                    ...
                    <div className="col-lg-4 col-sm-offset-3 col-lg-offset-0 col-md-6 col-sm-12 col-xs-12 price">
                        <div className="doc-info-sistem__icon-block">
