            ...
            <div className="container">
                <div className="row">
                    <div className="first-div">
                        ...
                        <p><strong>Scopul nostru</strong> - să ajutăm pacienții să găsească un medic profesionist
                            și &icirc;i
                            programăm la consultație sau servicii medicale, c&acirc;t mai rapid. Pentru aceasta, am
                            creat o bază de date a doctorilor,
                            clinicilor și centrelor de diagnostic din Republica Moldova. Adunăm recenziile pacienților,
                            după consultarea cu medicul și le publicăm pe portal. Oferim informații detaliate despre
                            medicii specialiști
                        ...
                        <ol>
                            <li><span className="span">Alegeți un doctor personal</span>
                                <ul className="disc">
                                    ...
                                    <li className="li">alegerea doctorului după specializare, preț consultație, adresa,
                                        rating și recenzii.
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li>
                                ...
                                <div className="li">După programare, veți primi un SMS de reamintire cu data și adresa
                                    programării;
                                </div>
                            </li>
                            <li><span className="span">Feedback</span>
                                ...
                                <ul className="disc">
                                    ...
                                    <li className="li">Dvs ajuți și alți pacienți la alegerea doctorului de pe site.
                                    </li>
                                </ul>
                            </li>
                        </ol>
