         ...
         <div className="main">
             <div className="container ">
                 <div className="row">
                     ...
                     <div>&Icirc;nțelegem perfect c&acirc;t de valoros este ratingul doctorului afișat pe pagina noastră.
                     ...
                     <p>
                         <strong>Feedbackul vine direct de la pacienți.</strong> După ce pacientul a făcut vizita la medic,
                     ...
                     <div className="divs">
                         ...
                         <ul>
                             ...
                             <li>calificarea doctorului &ndash; grija cu care a făcut examinarea pacientului &icirc;n timpul consultației;
                             </li>
                     ...
                     <div className="divs">
                        ...
                        <p><strong> Feedbackul</strong> și comentariile pacienților noștri sunt indispensabile serviciului
                     ...
                     <div className="divs">
                         ...
                         probabilitatea ca pe site-ul nostru să apară comentarii și păreri de la pacienți inexistenți.
                         </p>
                     </div>
                     <div className="divs">
